...
- `AUTH_API_BASEURL` - This is the base url for the Admin API. Auth0 calls this the Management API, while Keycloak the Admin API.
  ...
  - For keycloak, this url will look something like this: `https://github.com/Jeppzify/neosync/admin/realms/neosync-stage`. The pattern is: `<baseurl>/admin/realms/<realm>`
