...
The cluster is declaratively defined [here](https://github.com/Jeppzify/neosync/tree/main//tilt/kind/cluster.yaml)

The below command invokes the cluster-create script that can be found [here](https://github.com/Jeppzify/neosync/tree/main//tilt/scripts/cluster-create.sh)
...
Refer to the top-level [Tiltfile](https://github.com/Jeppzify/neosync/tree/main//Tiltfile) for a clear picture of everything that runs.
