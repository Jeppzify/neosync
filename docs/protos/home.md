...
All of the generated code lives [here](https://github.com/Jeppzify/neosync/tree/main/backend/gen/go/protos/mgmt/v1alpha1).
...
All of the generated code lives [here](https://github.com/Jeppzify/neosync/tree/main/frontend/packages/sdk).

### Protos

All of Neosync's protos are public and can be found [here](https://github.com/Jeppzify/neosync/tree/main/backend/protos).
